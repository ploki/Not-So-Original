...
function admin_toggle_comment() {
    var comment_form = document.getElementById('admin_comment_form');
    var showlink=document.getElementById('admin_showlink');
    var hidelink=document.getElementById('admin_hidelink');
    if(comment_form.style.display == 'none') {
	comment_was = comment_form.style.display; 
	comment_form.style.display = '';
	hidelink.style.display='';
